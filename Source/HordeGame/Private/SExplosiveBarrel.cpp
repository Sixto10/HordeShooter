...
ASExplosiveBarrel::ASExplosiveBarrel()
{
    ...
    // Set to physics body to let radial component affect us (eg. when a nearby barrel explode)
...
void ASExplosiveBarrel::OnHealthChanged(USHealthComponent * OwningHealthComp, float Health, float HealthDelta, const UDamageType * DamageType,
